    ...
    return (
        <div className='vespera-container relative min-h-screen overflow-hidden bg-black text-white'>
          ...
          `,
            ...
            {/* Header */}
            <div className='absolute top-6 right-0 left-0 z-10 text-center'>
                <h1 className='font-orbitron mb-2 text-5xl font-bold tracking-wider'>
                    <span className='text-shadow-red'>VESPERA</span>
                    <span className='font-light text-[#F8F8F8]'> PUBLISHING</span>
                </h1>
                <p className='font-montserrat mx-auto max-w-2xl text-lg text-[#F8F8F8]/80'>
            ...
            <div className='absolute inset-0 z-10 flex items-center justify-center'>
                <div className='container mx-auto flex h-full flex-col items-stretch justify-between px-4 pt-24 pb-8 md:flex-row'>
                    {/* Left panel - Archivist and info */}
                    <div className='flex w-full flex-col md:w-1/3 md:pr-6'>
                        {/* Archivist interactive panel */}
                        <div className='mb-6 rounded-lg border border-[#DC143C]/30 bg-[#1A0A0A]/80 p-6 backdrop-blur-sm'>
                            <div className='mb-4 flex items-center'>
                                <div className='flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-[#DC143C] to-[#FF4040]'>
                                    <svg
                                        width='24'
                                        height='24'
                                        viewBox='0 0 24 24'
                    ...
                    <div className='mt-6 w-full md:mt-0 md:w-2/3'>
                        ...
                        <div
                            ref={searchRef}
                            className='mb-6 rounded-lg border border-[#DC143C]/30 bg-[#1A0A0A]/80 p-4 backdrop-blur-sm'>
                            <div className='flex items-center'>
                                <input
                                    ...
                                    className='flex-grow rounded-l border border-[#DC143C]/20 bg-black/50 px-4 py-2 text-[#F8F8F8] focus:border-[#DC143C]/60 focus:outline-none'
                                />
                                <button
                                    onClick={handleSearch}
                                    className='rounded-r bg-[#DC143C] px-4 py-2 text-white transition-colors hover:bg-[#FF4040]'>
                                    <svg
                                        width='18'
                                        height='18'
                                        viewBox='0 0 24 24'
                            ...
                            {searchResults.length > 0 && (
                                <div className='mt-4 max-h-60 overflow-y-auto'>
                                    <div className='mb-2 text-sm text-[#F8F8F8]/60'>
                                    ...
                                    <div className='space-y-2'>
                                        {searchResults.map((book) => (
                                            <div
                                                ...
                                                className='cursor-pointer rounded-lg border border-[#DC143C]/20 p-3 transition-colors hover:bg-[#190808]'>
                                                <div className='flex justify-between'>
                                                    <h3 className='font-medium text-[#F8F8F8]'>{book.title}</h3>
                                                    <span className='text-xs text-[#F8F8F8]/50'>{book.year}</span>
                                                </div>
                                                <p className='mt-1 text-sm text-[#F8F8F8]/60'>By {book.author}</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            {/* Books display */}
                            <div className='grid h-[calc(100%-130px)] grid-cols-1 gap-4 overflow-y-auto pr-2 md:grid-cols-2'>
                                {books
                                    ...
                                    .map((book, index) => (
                                        <div
                                            key={book.id}
                                            onClick={() => handleBookSelect(book)}
                                            className='group relative h-40 cursor-pointer rounded-lg border border-[#DC143C]/20 p-4 transition-all hover:border-[#DC143C]/60 hover:shadow-[0_0_15px_rgba(220,20,60,0.2)]'
                                            style={{
                                            ...
                                            <div className='flex h-full flex-col'>
                                                <h3 className='font-montserrat font-medium text-[#F8F8F8] transition-colors group-hover:text-[#DC143C]'>
                                                    {book.title}
                                                </h3>
                                                <p className='mb-1 text-sm text-[#F8F8F8]/60'>By {book.author}</p>
                                                <p className='mb-2 text-xs text-[#F8F8F8]/40'>
                                                    {book.year} • {book.pages} pages
                                                </p>
                                                <p className='line-clamp-2 flex-grow text-sm text-[#F8F8F8]/70'>
                                                    {book.preview}
                                                </p>

                                                {/* Interactive element */}
                                                <div className='mt-auto text-xs text-[#F8F8F8]/50 transition-colors group-hover:text-[#DC143C]/80'>
                                                    Tap to open holographic display
                                                </div>
                                            </div>
            ...
            {showArchivist && (
                <div className='fixed bottom-8 left-1/2 z-30 mx-auto w-full max-w-lg -translate-x-1/2 rounded-lg border border-[#DC143C]/40 bg-[#190808]/95 p-6 shadow-[0_0_30px_rgba(220,20,60,0.3)] backdrop-blur-sm'>
                    <div className='mb-4 flex items-center'>
                        <div className='flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r from-[#DC143C] to-[#FF4040]'>
                            <svg
                                width='20'
                                height='20'
                                viewBox='0 0 24 24'
                        ...
                        <div className='ml-3'>
                            <h3 className='font-orbitron text-lg text-[#DC143C]'>Vesper</h3>
                    ...
                    <div className='archivistMessage mb-4 font-mono leading-relaxed text-[#F8F8F8]'>
                        {archivistMessage}
                    </div>
                    ...
                    <div className='flex items-center'>
                        <input
                            ...
                            className='flex-grow rounded-l border border-[#DC143C]/20 bg-black/40 px-4 py-2 text-[#F8F8F8] focus:border-[#DC143C]/60 focus:outline-none'
                        />
                        <button
            ...
            {bookOpen && activeBook && (
                <div className='fixed inset-0 z-40 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm'>
                    <div
                        className={`relative max-h-[80vh] w-full max-w-4xl overflow-hidden rounded-lg border border-[#DC143C]/40 bg-[#190808] shadow-[0_0_30px_rgba(220,20,60,0.3)] transition-all duration-500 ${bookOpen ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}>
                        {/* Book header */}
                        <div className='flex items-center justify-between border-b border-[#DC143C]/30 bg-[#1A0A0A] p-4'>
                            <div>
                                <h2 className='font-orbitron text-xl text-[#DC143C]'>{activeBook.title}</h2>
                        ...
                        {/* Book content */}
                        <div className='max-h-[calc(80vh-85px)] overflow-y-auto p-6'>
                            <div className='prose prose-invert max-w-none'>
                                <p className='mb-4 text-lg'>{activeBook.preview}</p>
                                <p>
                            ...
                            <div className='mt-8 flex items-center justify-between border-t border-[#DC143C]/20 pt-4'>
                                ...
                                <span className='text-sm text-[#F8F8F8]/40'>Page 1 of {activeBook.pages}</span>
                            </div>
                        </div>
                    </div>
                </div>
